...
namespace Suifengpiao\Admin\Console;

use Suifengpiao\Admin\Auth\Database\Administrator;
...
class InstallCommand extends Command
{
    ...
    public function initDatabase()
    {
        ...
        if (Administrator::count() == 0) {
            $this->call('db:seed', ['--class' => \Suifengpiao\Admin\Auth\Database\AdminTablesSeeder::class]);
        }
    }
