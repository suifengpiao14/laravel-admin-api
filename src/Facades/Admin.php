...
namespace Suifengpiao\Admin\Facades;
 ...
 * Class Admin.
 *
 * @method static \Suifengpiao\Admin\Grid grid($model, \Closure $callable)
 * @method static \Suifengpiao\Admin\Form form($model, \Closure $callable)
 * @method static \Suifengpiao\Admin\Tree tree($model, \Closure $callable = null)
 * @method static \Suifengpiao\Admin\Layout\Content content(\Closure $callable = null)
...
class Admin extends Facade
{
    ...
    {
        return \Suifengpiao\Admin\Admin::class;
    }
}
