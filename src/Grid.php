...
use Suifengpiao\Admin\Grid\Column;
use Suifengpiao\Admin\Grid\Displayers\Actions;
use Suifengpiao\Admin\Grid\Displayers\RowSelector;
use Suifengpiao\Admin\Grid\Exporter;
use Suifengpiao\Admin\Grid\Filter;
use Suifengpiao\Admin\Grid\Model;
use Suifengpiao\Admin\Grid\Row;
use Suifengpiao\Admin\Grid\Tools;
...
class Grid
{
     ...
     *
     * @var \Suifengpiao\Admin\Grid\Model
     */
    protected $model;
     ...
     * The grid Filter.
     *
     * @var \Suifengpiao\Admin\Grid\Filter
     */
    protected $filter;
    ...
    {
        $map = [
            'editable'    => \Suifengpiao\Admin\Grid\Displayers\Editable::class,
            'switch'      => \Suifengpiao\Admin\Grid\Displayers\SwitchDisplay::class,
            'switchGroup' => \Suifengpiao\Admin\Grid\Displayers\SwitchGroup::class,
            'select'      => \Suifengpiao\Admin\Grid\Displayers\Select::class,
            'image'       => \Suifengpiao\Admin\Grid\Displayers\Image::class,
            'label'       => \Suifengpiao\Admin\Grid\Displayers\Label::class,
            'button'      => \Suifengpiao\Admin\Grid\Displayers\Button::class,
            'link'        => \Suifengpiao\Admin\Grid\Displayers\Link::class,
            'badge'       => \Suifengpiao\Admin\Grid\Displayers\Badge::class,
            'progressBar' => \Suifengpiao\Admin\Grid\Displayers\ProgressBar::class,
            'radio'       => \Suifengpiao\Admin\Grid\Displayers\Radio::class,
            'checkbox'    => \Suifengpiao\Admin\Grid\Displayers\Checkbox::class,
            'orderable'   => \Suifengpiao\Admin\Grid\Displayers\Orderable::class,
        ];
    ...
    public function render()
    {
        ...
        $rows =[];
        /** @var \Suifengpiao\Admin\Grid\Row $row */
